...
/**
 * Represents a buydown configuration for reduced interest rates during initial
 * years
 */
public class Buydown {
    ...
    /**
     * Creates a 3-2-1 buydown (3% reduction first year, 2% reduction second year,
     * 1% reduction third year)
     */
