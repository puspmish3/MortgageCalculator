<template>
  <div class="space-y-6 sm:space-y-8">
    ...
    <div class="text-center">
      <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Mortgage Calculator</h1>
      <p class="mt-2 text-base sm:text-lg text-gray-600 px-4">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
      <!-- Input Form -->
      <div class="card">
        <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Loan Details</h2>

        <MortgageForm @submit="handleCalculation" :loading="mortgageStore.isCalculating" />
      </div>

      <!-- Results -->
      <div class="card" v-if="mortgageStore.hasCalculation">
        <h2 class="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Calculation Results</h2>
    ...
    <div class="card" v-if="mortgageStore.hasCalculation">
      <AmortizationTable :schedule="mortgageStore.currentCalculation!.amortizationSchedule" />
    </div>

    <!-- Payment Chart -->
    <div class="card" v-if="mortgageStore.hasCalculation">
      <PaymentChart :schedule="mortgageStore.currentCalculation!.amortizationSchedule" />
    </div>
