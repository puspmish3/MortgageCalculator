<template>
  <div class="space-y-8">
    ...
    <div class="text-center">
      <h1 class="text-3xl font-bold text-gray-900">Mortgage Comparison</h1>
      <p class="mt-2 text-lg text-gray-600">
        Compare multiple mortgage options side by side
      </p>
    </div>
    ...
    <div v-if="mortgageStore.hasComparison" class="space-y-8">
          ...
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                ...
                <th v-for="(mortgage, index) in mortgageStore.comparisonResult!.mortgages" 
                    :key="index"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td v-for="(mortgage, index) in mortgageStore.comparisonResult!.mortgages" 
                    :key="index"
              ...
              <tr class="bg-gray-50">
                ...
                <td v-for="(mortgage, index) in mortgageStore.comparisonResult!.mortgages" 
                    :key="index"
                    class="px-6 py-4 whitespace-nowrap text-sm text-right font-medium text-gray-900">
                  ${{ mortgage.summary.loanAmount.toLocaleString(undefined, { minimumFractionDigits: 2 }) }}
                </td>
              </tr>
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
      ...
      <div class="space-y-8">
        ...
        <div v-for="(mortgage, index) in mortgageStore.comparisonResult!.mortgages" 
             :key="index" 
             class="card">
          <div class="mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg text-sm">
              <div>
                ...
                <span class="font-medium ml-2">${{ mortgage.summary.loanAmount.toLocaleString(undefined, { minimumFractionDigits: 2 }) }}</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span class="font-medium ml-2">${{ mortgage.monthlyPayment.toLocaleString(undefined, { minimumFractionDigits: 2 }) }}</span>
              </div>
            </div>
          </div>
          <AmortizationTable 
      ...
      <div class="card">
        ...
        <p class="text-sm text-gray-600">Download your mortgage comparison as PDF or Excel document.</p>
      </div>
    </div>
...
const canCompare = computed(() => {
  return mortgageInputs.value.length >= 2 && 
         mortgageInputs.value.every(input => 
           input.loanAmount > 0 && 
...
watch(() => mortgageStore.comparisonResult, (newResult) => {
  if (newResult) {
